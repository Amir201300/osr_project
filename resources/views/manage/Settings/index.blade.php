...
@section('content')
    ...
    <div class="page-wrapper">
                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">سياستنا ومن نحن</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title">سياستنا ومن نحن</h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
                                        &nbsp;
                                    </div>
        ...
        <!-- footer -->
        <!-- ============================================================== -->
    @include('manage.Settings.show')
    @include('manage.Settings.form')
    <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    </div>
...
@section('script')
    ...
    @include('manage.Settings.script')
