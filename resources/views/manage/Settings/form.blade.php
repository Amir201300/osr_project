                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-email">سياستنا</label>
                                            <textarea   id="our_policy" name="our_policy" required class="form-control"   >
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-email">من نحن</label>
                                            <textarea   id="about_us" name="about_us" required class="form-control"   >
                                            </textarea>
                                        </div>
                                    </div>
