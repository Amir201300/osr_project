                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-email">السؤال</label>
                                            <textarea   id="question" name="question" required class="form-control"   >
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-email">الجواب</label>
                                            <textarea   id="answer" name="answer" required class="form-control"   >
                                            </textarea>
                                        </div>
                                    </div>
