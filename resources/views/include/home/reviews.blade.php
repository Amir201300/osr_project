<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card earning-widget">
            <div class="card-body">
                <h4 class="m-b-0">اكثر المنتجات مشاهدة</h4>
            </div>
            <div class="border-top scrollable" style="height:365px;">
                <table class="table v-middle no-border">
                    <tbody>
                    @foreach(getProducts(1,5) as $row)
                        @php
                    ...
                    <tr>
                        <td>
                            <img src="{{getImageUrl('Product_images',productImage($row))}}" width="50" class="rounded-circle" alt="logo">
                        </td>
                        <td>{{$row->name}}</td>
                        <td align="right">
                            <span class="label label-{{$array[$k]}}">{{$row->view}} مشاهدة</span>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
