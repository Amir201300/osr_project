            ...
            <form>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 showDetilse">
                            <h5><i class="fas fa-image"></i>المدينة</h5>
                            <p class="status valueModal" id="cityShow"></p>
                        </div>

                        <div class="col-md-6 showDetilse">
                            <h5><i class="fas fa-check"></i>المنطقة</h5>
                            <p class="status valueModal" id="areaShow"></p>
                        </div>

                        <div class="col-md-6 showDetilse">
                            <h5><i class="fas fa-check"></i>نوع العضو</h5>
                            <p class="status valueModal" id="userTypeShow"></p>
                        </div>
